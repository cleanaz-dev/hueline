  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-3 overflow-x-auto pb-4 scrollbar-hide px-1 pt-2">
        {hasActiveUpscaleJob ? (
          <div className="relative w-24 h-24 shrink-0 rounded-xl overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 flex flex-col items-center justify-center">
            <div className="flex gap-2 mb-2">
              <BsBadge4K className="w-6 h-6 text-primary animate-pulse" />
          ...
          <Link
            ...
            className="relative w-24 h-24 shrink-0 rounded-xl overflow-hidden transition-all bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 flex flex-col items-center justify-center group cursor-pointer hover:ring-2 ring-primary"
          >
