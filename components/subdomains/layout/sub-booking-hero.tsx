    ...
    <section className="w-full max-w-5xl mx-auto mb-8">
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-4 mb-8">
        ...
        <p className="text-gray-500 text-lg max-w-lg mx-auto font-light">
          ...
          <span className="font-medium text-gray-800"> {booking.roomType || "Home"}</span> renovation.
        </p>
      </div>
             ...
             <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                ...
                <div className="flex items-center gap-3">
                  <Avatar className="size-12 border-2 border-white shadow-md">
                    ...
                    <AvatarFallback className="bg-primary text-white">AN</AvatarFallback>
                  </Avatar>
                  <div>
                    <p className="font-bold text-gray-900 text-sm">Annalia</p>
                    <p className="text-xs text-primary font-medium">Design Consultant</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                   <div className="size-6 rounded-full bg-blue-50 flex items-center justify-center">
                     <Image src={PaletteImage} alt="logo" className="w-3 h-3 object-contain" />
                   </div>
                   <span className="text-[10px] text-gray-500 font-medium">Hue-Line Certified</span>
                </div>
             </div>
          </div>
