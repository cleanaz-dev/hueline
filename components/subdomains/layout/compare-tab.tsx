...
export default function CompareTab({
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="absolute bottom-2 md:bottom-6 left-1/2 -translate-x-1/2 z-20 bg-white/50 backdrop-blur-md p-1.5 md:p-3 rounded-2xl md:rounded-3xl shadow-xl border border-white/50 flex gap-4 md:gap-3 max-w-[90%]">
